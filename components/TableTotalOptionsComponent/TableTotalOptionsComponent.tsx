...
import SkeletonTableTotalOptionsComponent from "../SkeletonTableTotalOptionsComponent/SkeletonTableTotalOptionsComponent";

export function TableTotalOptionsComponent() {
    const { saveOptions, handleRemoveOption, handleClearOptions, getTotalPriceOfOptions, loading } = UseSavedOptions();
