...
import { IslaExcelDataResponse, IslaInterface, IslaTypes } from "@/types/cocinaTypes";
import NameFieldComponent from "../NameFieldComponent/NameFieldComponent";
import styles from "./IslaComponent.module.scss"
...
export default function IslaComponent({
    excelData,
    handleOptionSelect,
    selectedOption,
    handleSaveOptions,
            ...
            <div className={styles["wrapper-column"]}>
                ...
                <div className={styles["wrapper-row"]}>
                    ...
                    <SelectFieldComponent title="Fondo" excelData={excelData.fondos.slice(0, 2)}
                        isDisabled={selectedOption.cierreAtras.data.name.length > 0} showNumericInput={false}
                        islaProps={{
                            selectedOption: selectedOption,
                ...
                <div className={styles["wrapper-row"]}>
                    <SelectFieldComponent title="Puertas" subTitle="Precio del frente contemplado en material exterior" excelData={excelData.puertas}
                        ...
                        btnBlocked={selectedOption.cajones.data.name.trim().length > 0 && (selectedOption.cajones.data.name === "No" ? false : true)}
                        islaProps={{
                            selectedOption: selectedOption,
